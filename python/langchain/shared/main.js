  ...
  const chapters = [
    {
      name: '基础入门',
      cards: [
        BasicsCards.whatIsLangChain,
        BasicsCards.installation,
        BasicsCards.coreArchitecture
      ]
    },
    {
      name: '模型与提示',
      cards: [
        ModelsCards.llmBasics,
        ModelsCards.chatModels,
        ModelsCards.promptTemplates,
        ModelsCards.fewShotPrompt,
        ModelsCards.outputParsers
      ]
    },
    {
      name: 'LCEL 链',
      cards: [
        LCELCards.whatIsLCEL,
        LCELCards.runnableSequence,
        LCELCards.parallelBranch,
        LCELCards.routingFallback
      ]
    },
    {
      name: '记忆系统',
      cards: [
        MemoryCards.whyMemory,
        MemoryCards.bufferMemory,
        MemoryCards.summaryMemory,
        MemoryCards.persistMemory
      ]
    },
    {
      name: 'RAG 检索增强',
      cards: [
        RAGCards.whatIsRAG,
        RAGCards.documentLoaders,
        RAGCards.textSplitting,
        RAGCards.embeddings,
        RAGCards.vectorStores,
        RAGCards.ragChain
      ]
    },
    {
      name: '智能体 Agent',
      cards: [
        AgentCards.whatIsAgent,
        AgentCards.builtinTools,
        AgentCards.customTools,
        AgentCards.reactAgent,
        AgentCards.structuredChat
      ]
    },
    {
      name: '实战项目',
      cards: [
        ProjectCards.pdfQA,
        ProjectCards.webSearch,
        ProjectCards.multiAgent
      ]
    }
  ];
